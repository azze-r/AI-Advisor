...
if 'conversation' not in st.session_state:
    st.session_state.conversation = []  # List to store conversation history

# Streamlit app setup
st.title("مساعد PDF")

st.write("قم برفع ملفات PDF واسأل أسئلة بناءً على محتواها.")
...
if uploaded_pdfs:
    ...
    if st.button("إرسال"):
        if question:
            ...
            # Find relevant chunks and ask OpenAI for an answer
...
st.markdown("""
    ...
    h1 {
        ...
        unicode-bidi: embed; /* Handles mix of Arabic and English */
    }
